...
// Durable-key launch preflight and repair are daemon-owned. Older daemons do
// not expose these RPCs, so a mixed client must force a re-exec.
const PROTOCOL_VERSION_BASE: u32 = 71;
