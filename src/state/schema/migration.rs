...
mod journal;
mod steps;
#[path = "migration/steps/v18_v19.rs"]
mod v18_v19;
#[path = "migration/steps/v19_v20.rs"]
mod v19_v20;
#[path = "migration/steps/v20_v21.rs"]
mod v20_v21;
#[path = "migration/steps/v21_v22.rs"]
mod v21_v22;
...
const MIGRATIONS: [Migration; (version::SCHEMA_VERSION - OLDEST_SUPPORTED_VERSION) as usize] = [
    ...
    Migration {
        from: 13,
        apply: steps::v13_to_v14,
    },
    Migration {
        from: 14,
        apply: steps::v14_to_v15,
    },
    Migration {
        from: 15,
        apply: steps::v15_to_v16,
    },
    Migration {
        from: 16,
    ...
    Migration {
        from: 18,
        apply: v18_v19::migrate,
    },
    Migration {
        from: 19,
        apply: v19_v20::migrate,
    },
    Migration {
        from: 20,
        apply: v20_v21::migrate,
    },
    Migration {
        from: 21,
        apply: v21_v22::migrate,
    },
    Migration {
        from: 22,
