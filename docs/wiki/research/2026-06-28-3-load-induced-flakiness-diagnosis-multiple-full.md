...
source_lines: 2204-2222
agent_attribution: main
has_preregistered_criteria: true
has_method: true
has_structured_report: true
characterization: "Load-induced flakiness diagnosis: multiple full-suite runs reveal non-deterministic failures moving between tests (not one bug), verdict timing race not logic regression"
captured_at: 2026-06-28T12:45:54Z
---

Load-induced flakiness diagnosis: multiple full-suite runs reveal non-deterministic failures moving between tests (not one bug), verdict timing race not logic regression
