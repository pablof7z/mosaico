...
agent_attribution: a067926378f0c4ada (de-flake agent)
has_preregistered_criteria: true
has_method: true
has_structured_report: true
characterization: "Root-cause investigation of integration test flakiness: identified croissant POSIX-semaphore leak as cause via 14-run baseline + minimal C probe; verdict = infrastructure bug, not test race."
captured_at: 2026-07-10T00:10:13Z
---

Root-cause investigation of integration test flakiness: identified croissant POSIX-semaphore leak as cause via 14-run baseline + minimal C probe; verdict = infrastructure bug, not test race.
